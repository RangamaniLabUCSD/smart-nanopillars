...
do
    ...
    do
        ...
        --outdir /root/scratch/results_nanopillars/nanopillars_h${heightArray[idx]}_p${pitchArray[idx]}_r${radiusArray[idx]}_cellRad${cellRadArray[idx]}_nprate${nprateArray[outeridx]}_curvSens${curv0Array[outeridx]}_NPCDensityCorrection \
