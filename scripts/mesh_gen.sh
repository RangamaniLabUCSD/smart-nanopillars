...
python3 main.py mechanotransduction-preprocess --shape circle --hEdge 0.3 --hInnerEdge 0.3 --mesh-folder /root/scratch/write-meshes/mechanotransduction/meshes/circle_hEdge_0.3_full3dtrue --full-3d
echo "Writing full rect mesh..."
python3 main.py mechanotransduction-preprocess --shape rect --hEdge 0.3 --hInnerEdge 0.3 --mesh-folder /root/scratch/write-meshes/mechanotransduction/meshes/rect_hEdge_0.3_full3dtrue --full-3d
echo "Writing full star mesh..."
python3 main.py mechanotransduction-preprocess --shape star --hEdge 0.3 --hInnerEdge 0.3 --mesh-folder /root/scratch/write-meshes/mechanotransduction/meshes/star_hEdge_0.3_full3dtrue --full-3d
echo "Done."