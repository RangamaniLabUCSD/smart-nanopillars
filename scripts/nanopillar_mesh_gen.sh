...
do
    ...
    python3 main.py mechanotransduction-preprocess --shape circle --hEdge 0.3 --hInnerEdge 0.4 \
--mesh-folder /root/shared/gitrepos/smart-comp-sci-data/meshes/nanopillars/nanopillars_h${heightArray[idx]}_p${pitchArray[idx]}_r${radiusArray[idx]}_cellRad${cellRadArray[idx]} \
