...
do
    ...
    do
        ...
        do
            python3 main.py --partition=$partition --submit-ex3 phosphorylation --diffusion $diffusion --curRadius $radius --mesh-folder "meshes-phosphorylation/curRadius_${radius}_refined_${refinement}"
        done
    done
done
...
do
    ...
    do
        for diffusion in 0.01 0.1 1.0 10.0 100.0
        do
            python3 main.py --partition=$partition --submit-ex3 phosphorylation --axisymmetric --diffusion $diffusion --curRadius $radius --mesh-folder "meshes-phosphorylation/curRadius_${radius}_axisymmetric_refined_${refinement}"
        done
    done
done
...
do
    python3 main.py --ntasks $ntasks --partition=$partition --submit-ex3 phosphorylation --diffusion 1.0 --curRadius 10 --mesh-folder "meshes-phosphorylation/curRadius_10_refined_2"
done
