...
do
    ...
    do
        ...
        do
            python3 main.py --submit-ex3 phosphorylation --diffusion $diffusion --curRadius $radius --num-refinements $refinement --mesh-folder "meshes-phosphorylation/curRadius_${radius}_refined_${refinement}"
        done
    done
done
...
do
    ...
    do
        for diffusion in 0.01 0.1 1.0 10.0 100.0
        do
            python3 main.py --submit-ex3 phosphorylation --axisymmetric --diffusion $diffusion --curRadius $radius --num-refinements $refinement --mesh-folder "meshes-phosphorylation/curRadius_${radius}_axisymmetric_refined_${refinement}"
        done
    done
done
