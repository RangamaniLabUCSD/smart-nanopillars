...
do
    ...
    do
        ...
        --mesh-folder /root/scratch/meshes/nanopillars_finalCalcCoarse/nanopillars_indent${indentArray[idx]} \
        --time-step 0.01 --e-val 10000000 \
        --outdir /root/scratch/results_nanopillars_indentation/nanopillars_indent${indentArray[idx]}_a0_${a0Array[outer_idx]}\
        --reaction-rate-on-np 1 --curv-sens 1 --WASP-rate 0.01 \
        --a0-npc ${a0Array[outer_idx]} --nuc-compression ${indentArray[idx]}
        sleep 100
    done
done
